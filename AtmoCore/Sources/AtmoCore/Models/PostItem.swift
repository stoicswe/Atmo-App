...
public struct PostItem: Identifiable, Hashable, Sendable {
    ...
    // MARK: - Reason
    public enum FeedReason: Hashable, Sendable {
        case repost(byDID: String, byHandle: String, byDisplayName: String?, indexedAt: Date)
    }

    // MARK: - Init from ATProtoKit
    public init(feedPost: AppBskyLexicon.Feed.FeedViewPostDefinition) {
    ...
    public init(postView: AppBskyLexicon.Feed.PostViewDefinition) {
        let post = postView
        self.uri = post.uri
        self.id = post.uri
        self.cid = post.cid
    ...
    public init(pendingURI: String, handle: String, text: String) {
        self.uri = pendingURI
        self.id = pendingURI
        self.cid = ""
        self.authorDID = ""
    ...
    init(
        testURI: String,
        authorDID: String = "did:example:alice",
