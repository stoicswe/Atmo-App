...
public struct WalletPassTheme: Identifiable, Hashable, Sendable, Codable {
    ...
    /// Who made the artwork and under which licence — shown next to the
    /// theme so stock-image terms are honoured.
    public let credit: String?

    public init(id: String, name: String, backgroundColor: RGB, foregroundColor: RGB, labelColor: RGB, credit: String? = nil) {
        self.id = id
        self.name = name
